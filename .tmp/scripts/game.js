...
game.state.add('play', {
    ...
    create: function create() {
        ...
        var upgradeButtonsData = [{ icon: 'dagger', name: 'Attack', level: 0, cost: 5, purchaseHandler: function purchaseHandler(button, player) {
                player.clickDmg += 1;
            } }, { icon: 'swordIcon1', name: 'Auto-Attack', level: 0, cost: 25, purchaseHandler: function purchaseHandler(button, player) {
                player.dps += 5;
            } }];
    ...
    onUpgradeButtonClick: function onUpgradeButtonClick(button, pointer) {
    ...
    onClickCoin: function onClickCoin(coin) {
        if (!coin.alive) {
            return;
        }
    ...
    onKilledMonster: function onKilledMonster(monster) {
    ...
    onRevivedMonster: function onRevivedMonster(monster) {
        monster.position.set(this.game.world.centerX + 100, this.game.world.centerY + 50);
        // update the text display
        this.monsterNameText.text = monster.details.name;
        this.monsterHealthText.text = monster.health + 'HP';
    },
    onClickMonster: function onClickMonster(monster, pointer) {
